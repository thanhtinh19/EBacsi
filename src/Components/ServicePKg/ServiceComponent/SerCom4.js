...
export default function ServiceComponent4() {
    return (
            ...
            <div className='container-intro'>
                <div className='title-intro'>
                    <p><span className='span-intro'>
                        ...
                        <img className='icon-img' src='../../img/icon/right.png' />
                        {data.infPackage[3].title}
                    </p>
                </div>
                <div className='content-sercom'>
                    <div className='img-title-sercom'>
                        <img src={data.infPackage[3].image} />
                        <div className='title-sercom'>
                            <h3>{data.infPackage[3].title}</h3>
                            <img src='../../../img/icon/Website---eBacsi---final---cut_17.jpg' />
                            <p className='describe-sercom'><span>Định nghĩa gói khám: </span> {data.infPackage[3].define}</p>
                    ...
                    <div className='detail-information'>
                        ...
                        <p>{data.infPackage[3].describe.map(index => {
                            return (
                                <p>{index}</p>
                            )
                        })}</p>
                        ...
                        <p>{data.proceducePkg[0].Proceduce.map(index => {
                            return (
                                <p>{index}</p>
                            )
                        })}</p>
                        <span>4. Chi tiết danh mục khám: </span> <br />
                        <img src={data.infPackage[3].detail} />
