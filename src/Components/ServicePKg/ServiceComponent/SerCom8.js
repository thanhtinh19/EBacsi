...
export default function ServiceComponent8() {
    return (
            ...
            <div className='container-intro'>
                <div className='title-intro'>
                    <p><span className='span-intro'>
                        ...
                        <img className='icon-img' src='../../img/icon/right.png' />
                        {data.infPackage[7].title}
                    </p>
                </div>
                <div className='content-sercom'>
                    <div className='img-title-sercom'>
                        <img src={data.infPackage[7].image} />
                        <div className='title-sercom'>
                            <h3>{data.infPackage[7].title}</h3>
                            <img src='../../../img/icon/Website---eBacsi---final---cut_17.jpg' />
                            <p className='describe-sercom'><span>Định nghĩa gói khám: </span> {data.infPackage[7].define}</p>
                    ...
                    <div className='detail-information'>
                        ...
                        <p>{data.infPackage[7].describe.map(index => {
                            return (
                                <p>{index}</p>
                            )
                        })}</p>
                        ...
                        <img src={data.infPackage[7].detail} />
