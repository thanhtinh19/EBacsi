            ...
            <div className='container-intro'>
                ...
                <div className='content-sercom'>
                    ...
                    <div className='detail-information'>
                        ...
                        <p>{data.infPackage[0].describe.map(index => {
                            return(
                                <p>{index}</p>
                            )
                        })}</p>
                        ...
                        <img src={data.infPackage[0].detail}/>
